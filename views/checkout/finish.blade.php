				...
				<div class="row">
					<div class="span12">
						<div class="well">
							...
							Detail pesanan Anda telah berhasil dikirim melalui email Anda. Setelah melakukan pembayaran harap melakukan konfirmasi pembayaran pada bagian bawah halaman
						</div>
					</div>
					@if($datapembayaran=='1')
						<div class="span12">
