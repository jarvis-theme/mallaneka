<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            ...
            <div class="product-page-product-wrap jqzoom-stage" style="background: #fff;">

                <div class="clearfix">

                    <a href="{{url(product_image_url($produk->gambar1))}}" id="jqzoom" data-rel="gal-1">

                        <img src="{{url(product_image_url($produk->gambar1))}}" alt="{{ $produk->nama }}" title="{{ $produk->nama }}" />
            ...
            <ul class="jqzoom-list">
                ...
                <li>
                    ...
                    <a class="zoomThumbActive" href="javascript:void(0)" data-rel="{gallery:'gal-1', smallimage: '{{url(product_image_url($produk->gambar1))}}', largeimage: '{{url(product_image_url($produk->gambar1,'large'))}}'}">

                        <img src="{{url(product_image_url($produk->gambar1, 'thumb'))}}" alt="{{ $produk->nama }} 1" title="{{ $produk->nama }} 1" />
                ...
                <li>
                    ...
                    <a href="javascript:void(0)" data-rel="{gallery:'gal-1', smallimage: '{{url(product_image_url($produk->gambar2))}}', largeimage: '{{url(product_image_url($produk->gambar2,'large'))}}'}">

                        <img src="{{url(product_image_url($produk->gambar2, 'thumb'))}}" alt="{{ $produk->nama }} 2" title="{{ $produk->nama }} 2" />
                ...
                <li>
                    ...
                    <a href="javascript:void(0)" data-rel="{gallery:'gal-1', smallimage: '{{url(product_image_url($produk->gambar3))}}', largeimage: '{{url(product_image_url($produk->gambar3,'large'))}}'}">

                        <img src="{{url(product_image_url($produk->gambar3, 'thumb'))}}" alt="{{ $produk->nama }} 3" title="{{ $produk->nama }} 3" />
                ...
                <li>
                    ...
                    <a href="javascript:void(0)" data-rel="{gallery:'gal-1', smallimage: '{{url(product_image_url($produk->gambar4))}}', largeimage: '{{url(product_image_url($produk->gambar4,'large'))}}'}">

                        <img src="{{url(product_image_url($produk->gambar4, 'thumb'))}}" alt="{{ $produk->nama }} 4" title="{{ $produk->nama }} 4" />
            ...
            <div class="row" data-gutter="10">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box-highlight">
                        ...
                        <p class="product-page-price">{{$produk->nama}}</p>

                        <p class="text-muted text-sm text-uppercase">{{$produk->vendor}}</p>
                        ...
                        @if($produk->hargaCoret!='')
                        	...
                        	Harga Outlet <p class="product-page-price-list">{{price($produk->hargaCoret)}}</p>
                        ...
                        Harga Normal {{ price($produk->hargacoret) }}
                        ...
                        <form action="#" id="addorder">
	                        ...
	                        <div class="col-md-6">
                        		...
                        		<input class="form-control" type="text" name="qty" value="1" class="qty" pattern="[0-9]" />
                        ...
                        <div class="product-page-side-section">
                            ...
                            <h5 class="product-page-side-title"></h5>
	    ...
	    @foreach(other_product($produk) as $key=>$reproduk)
		    ...
		    @endif
		        ...
		        <div class="col-md-3 col-sm-6 col-xs-6">
		            ...
		            <div class="product " style="max-height: 330px;">
		                ...
		                <a class="product-link" href="{{product_url($reproduk)}}"></a>
