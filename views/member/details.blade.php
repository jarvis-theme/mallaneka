						...
						<table class="table table-striped tcart">
							...
							@foreach (list_order() as $item)
								<tr>
									...
									@if($pengaturan->checkoutType==3) 
										@if($item->status < 4)
										<button onclick="window.location.href='{{url('konfirmasipreorder/'.$item->id)}}'" class="btn btn-small btn-success" data-title="Edit" data-placement="top" data-tip="tooltip"><i class="icon-money"></i>Konfirmasi Sekarang</button>
										@endif 
									@endif
									@if($pengaturan->checkoutType==1) 
										@if($item->status <= 1)
										<button onclick="window.location.href='{{url('konfirmasiorder/'.$item->id)}}'" class="btn btn-small btn-success" data-title="Edit" data-placement="top" data-tip="tooltip"><i class="icon-money"></i>Konfirmasi Sekarang</button>
										@endif 
									@endif
									</td>
								</tr>
					...
					@else
                            <div class="col-md-12">
                                <div class="text-center">
                                    <p class="lead">Sorry, there is no order history recorded here.</p><a href="{{url('produk')}}" class="btn btn-primary btn-lg"><i class="fa fa-user"></i>Check our Product</a>
                                </div>
                            </div>
